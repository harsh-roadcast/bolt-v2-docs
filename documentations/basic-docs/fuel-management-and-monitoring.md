...
Fuel data is visualized directly within the **Vehicle Detail Card** on the live map.&#x20;
...
The platform uses advanced algorithmic checks to distinguish between normal usage and security events.
